  ...
  return (
    <div className="app-container">
      <aside className="sidebar">
        <Menu activeIndex={activeIndex} setActiveIndex={setActiveIndex} hoveredIndex={hoveredIndex} setHoveredIndex={setHoveredIndex}/>
      </aside>
      <main className="main-content">
        {activeIndex === null && <LandingPage currImageIndex={currImageIndex} setCurrImageIndex={setCurrImageIndex}/>}
        {activeIndex === 0 && <GetMeasurements></GetMeasurements>}
      </main>
    </div>
  );
}
